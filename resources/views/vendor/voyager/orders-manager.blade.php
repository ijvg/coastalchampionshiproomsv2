...
@section('page_header')
    ...
    <div class="container-fluid">
		<h1 class="page-title my-page-title">Orders Manager</h1>
	</div>
@stop
							...
							<div id="transManagerCon">
									...
									<div class="col-md-12">
										<div class="panel panel-bordered">
											<div class="panel-header">
												<h2 style="text-align: center;">Download Tournament Orders</h2>
											</div>
											<div class="panel-body">
								
												<form id="tournamentOrderExport" method="POST" action="/admin/orders-manager/export-tournament-orders">
													{{ csrf_field() }}
									
														<div class="form-group" id="tournamentSelectDropdown">
															<label class="control-label">Select Tournament to Export Orders</label>
															<select id="tournamentID" name="tournamentID" required class="form-control tournamentOrderExport">
														...
														<div class="form-group">
															...
															<button id="exportTournamentOrders" class="btn btn-success btn-submit">Export Tournament Orders</button>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="panel panel-bordered">
											<div class="panel-header">
												<h2 style="text-align: center;">Download Accounting Orders</h2>
											</div>
											<div class="panel-body">
								
												<form id="tournamentOrderExport" method="POST" action="/admin/orders-manager/export-accounting-data">
													{{ csrf_field() }}
														...
														<div class="form-group">
															...
															<button id="exportTournamentOrders" class="btn btn-success btn-submit">Export Accounting Data</button>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="panel panel-bordered">
											<div class="panel-header">
												<h2 style="text-align: center;">Cancel Order Requests</h2>
											</div>
											<div class="panel-body">
											  <div class="table-responsive">
												<table id="cancelOrdersDataTable" class="table table-hover" style="width: 100%;">
													<thead>
														<tr>
														  <th>First Name</th>
														  <th>Last Name</th>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="panel panel-bordered">
											<div class="panel-header">
												<h2 style="text-align: center;">Change Orders</h2>
											</div>
											<div class="panel-body">
											  <div class="table-responsive">
												<table id="changeOrdersDataTable" class="table table-hover" style="width: 100%;">
													<thead>
														<tr>
														  <th>First Name</th>
														  <th>Last Name</th>
								...
								{{-- <div class="row">
									<div class="col-md-12">
										<div class="panel panel-bordered">
											...
											<div class="panel-body">
											  <div class="table-responsive">
												<table id="allOrderDataTable" class="table table-hover" style="width: 100%;">
													<thead>
														<tr>
														  <th>First Name</th>
														  <th>Last Name</th>
...
<script type="text/javascript">
	window.onload = function() {
		...
		$(document).ready(function(){
			...
			$('#cancelOrdersDataTable').DataTable({
				processing: true,
				serverSide: true,
				responsive: true,
				ajax: { "url": "/admin/orders/get-cancel-requests"
					},
				columns: [
					{ data: 'first_name'},
					{ data: 'last_name'},
			...
			$('#changeOrdersDataTable').DataTable({
				processing: true,
				serverSide: true,
				responsive: true,
				ajax: { "url": "/admin/orders/get-change-requests"
					},
				columns: [
					{ data: 'first_name'},
					{ data: 'last_name'},
			...
			/*$('#exportTournamentOrders').click(function(e) {

				e.preventDefault();

				var trID = $("#tournamentOrderExport #tournamentID").val();
				...
				$.ajax({
					...
					type: "post",
					data: {"tournamentID": trID },
					dataType:'json',
					url: "/admin/orders-manager/export-tournament-orders",
		...
		/*	$('#customersDataTable').DataTable({
				...
				serverSide: true,
				responsive: true,
				ajax: { "url": "/admin/customers/get-all-customers-data"
					},
				columns: [
					{ data: 'first_name'},
					{ data: 'last_name'},
					...
					"render": function (data, type, row, meta) {
						...
						if (data.total_paid != 0.00) {
							rData = '<button class="btn btn-sm btn-danger refundCustomer pull-right delete" id="'+data.id+'"><i class="voyager-trash" style="margin-right: 3px;"></i><span class="hidden-xs hidden-sm">Refund</span></a>';
						}
			...
			$('#customersDataTable').on('click', '.refundCustomer', function (e) {
				...
				$.ajax({
					...
					dataType:'json',
					url: "/admin/tranactions/charge-remaining",
					success:function(data){
