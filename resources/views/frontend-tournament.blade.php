...
@section('content')
        ...
        <div id="homeOuterCon">
	        ...
	        <div id="tournamentBannerImageCon">
                @if ($tournament->banner_image_link && $tournament->banner_image)
                	
                	<a href="{{$tournament->banner_image_link}}"><img id="tournamentHeroImage" src="{{ Voyager::image( $tournament->banner_image ) }}" style="width: 100%;"></a>
                	
                @endif
                
                @if (!$tournament->banner_image_link && $tournament->banner_image)
                	
                	<img id="tournamentHeroImage" src="{{ Voyager::image( $tournament->banner_image ) }}" style="width: 100%;">
                	
                @endif
            </div>

            <div id="tournamentHeroImageCon">
                <img id="tournamentHeroImage" src="{{ Voyager::image( $tournament->image ) }}" style="width: 100%;">
                <p class="imageCredit">
            ...
            <div class="container">
                ...
                <div id="tournamentBtnsCon">
	                	...
	                	<a class="btn btn-lg btn-blue tournamentHotelApplicationBtn" href="{{ $tournament->hotel_button_link }}">View Hotels & Book Now</a>
