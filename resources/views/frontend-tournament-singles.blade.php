                    ...
                    <div class="card tournamentHotelCard">
                        ...
                        <div class="card-body">
                            ...
                            <div class="hotelDescriptionCon">
	                            ...
	                            @php $hotelTournamentAvailableRooms = 0; @endphp
	                            
	                            @foreach ($hotel->pivot->hotelTournamentRooms() as $hotelTournamentRoom)
                                    @php $hotelTournamentAvailableRooms = $hotelTournamentAvailableRooms + $hotelTournamentRoom->rooms_available; @endphp
                            ...
                            @if ($hotelTournamentAvailableRooms < 1)
                            	<div class="singleTournamentHotelGetCon">
	                            	<h4>Sold Out</h4>
                            	</div>
                            @else
                            
                            <div class="singleTournamentHotelGetCon">
	                            <a class="btn btn-lg btn-success tournamentHotelApplicationBtn" href="/tournament/{{ $tournament->slug }}/tournament-single-application-form?hotel={{$hotel->id}}">Get Rooms</a>
                            </div>
